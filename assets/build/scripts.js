	...
	Case.homeTwitter = function() {
		function handleTweets( tweets ) {
			...
			while( n < x ) {
				...
				var twitterHeader = '<a class="header" href="https://twitter.com/case_agency" target="_blank">@CASE_AGENCY</a><a class="topTwitterImg" href="https://twitter.com/case_agency" target="_blank"><img src="/assets/img/sm-twitter.png" alt="Twitter"></a>';
