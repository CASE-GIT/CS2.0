...
<head>
	...
	<?php endif; ?> -->
	<link rel="stylesheet" href="/assets/build/styles.css?v=<?php echo $version ?>"> <!-- remove -->
...
<body>
	<script>/*<![CDATA[*/(function(w,a,b,d,s){w[a]=w[a]||{};w[a][b]=w[a][b]||{q:[],track:function(r,e,t){this.q.push({r:r,e:e,t:t||+new Date});}};var e=d.createElement(s);var f=d.getElementsByTagName(s)[0];e.async=1;e.src='//a22050.actonsoftware.com/cdnr/49/acton/bn/tracker/22050';f.parentNode.insertBefore(e,f);})(window,'ActOn','Beacon',document,'script');ActOn.Beacon.track();/*]]>*/</script>
